...
import net.minecraft.src.TeamInfo;
...
public abstract class Minecraft implements Runnable
{
    ...
    //Team info stuff
    public TeamInfo serve;
    private static Thread teaminfo;
    ...
    public void startGame() throws LWJGLException
    {
        ...
        serve = new TeamInfo(session.username);
        serve.setVerbose(true);
        try {
        serve.connect("irc.esper.net");
        serve.joinChannel("#teaminfomod");
        System.out.println("HI" + session.username);
        teaminfo = new Thread(serve);
        teaminfo.start();
        } catch(Exception e) {
        	e.printStackTrace();
        }
