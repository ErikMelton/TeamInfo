...
public class GuiTeamInfoConfig extends GuiScreen {
    ...
    public void initGui() {
        controlList.clear();
        controlList.add(new GuiButton(0, width / 2 - 155, height / 2 + 5, 100, 20, (new StringBuilder()).append("Scale ").append((int) (Kovu.scale * 100F)).append("%").toString()));
        controlList.add(new GuiButton(1, width / 2 - 50, height / 2 + 5, 100, 20, (new StringBuilder()).append("Armor ").append(Kovu.armour ? "On" : "Off").toString()));
        controlList.add(new GuiButton(2, width / 2 + 55, height / 2 + 5, 100, 20, (new StringBuilder()).append("EmptyArmor ").append(Kovu.noarmour ? "On" : "Off").toString()));
        controlList.add(new GuiButton(3, width / 2 - 155, height / 2 + 5 + 24, 100, 20, (new StringBuilder()).append("Co-ords ").append(Kovu.coords ? "On" : "Off").toString()));
        controlList.add(new GuiButton(4, width / 2 - 50, height / 2 + 5 + 24, 100, 20, (new StringBuilder()).append("Hunger ").append(Kovu.hunger ? "On" : "Off").toString()));
